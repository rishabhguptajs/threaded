...
const Header = () => {
  return (
    <div className="flex flex-row shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,178,255,0.15)] align-middle items-center p-2  w-full rounded-lg justify-between bg-[#d9d9ff] text-[#1b1b2f] cursor-default">
